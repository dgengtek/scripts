...
def main():
    ...
    allowed_time_to_work_on_automating = across \
        * how_often_task_done_daily \
        * how_much_time_saved_in_seconds
    print("< within this time the task is worth automating")
    print("in s: {}".format(
        allowed_time_to_work_on_automating))
    print("in m: {}".format(
        allowed_time_to_work_on_automating/Decimal("60")))
    print("in h: {}".format(
        allowed_time_to_work_on_automating/Decimal("3600")))
    print("in d: {}".format(
...
def parse_args():
    ...
    parser.add_argument(
        "task_done_daily",
        help="how often is the task done daily")
    parser.add_argument(
        "time_saved",
        help="time saved in seconds")

    parser.add_argument(
            "--across",
            help="across how many years time saved",
            default="5",
